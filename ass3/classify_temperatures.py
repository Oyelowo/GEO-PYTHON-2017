...
for t in temperatures:
    if temperatures[0::3]: night.append(temperatures[0::3])
    elif temperatures[1::3]: day.append(temperatures[1::3])
    elif temperatures[2::3]:evening.append(temperatures[2::3])
