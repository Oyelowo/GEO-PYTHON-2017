...
df = data[['x', 'y', 'pt_r_tt_ud', 'pt_r_tt', 'car_r_t','car_r_t_ud', 'from_id', 'label_pt', "label_car"]]
...
# Add roads
#r = p.multi_line('x', 'y', source=rdfsource, color="red")
...
output_file = r"C:\Users\oyeda\Desktop\AUTOGIS\AUTOGIS_PERIOD2\assignment5\solution\accessi.html"
