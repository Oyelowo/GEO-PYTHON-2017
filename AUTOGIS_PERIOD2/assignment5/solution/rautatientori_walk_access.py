...
#rdf=rdf.fillna('')
##rdf=rdf.tail(22)
#rdf=rdf["x"].dropna(how='all')
##rdf.drop(df.index[[39]])
...
output_file = r"C:\Users\oyeda\Desktop\AUTOGIS\AUTOGIS_PERIOD2\assignment5\solution\Rautatientori_walk_access2.html"
