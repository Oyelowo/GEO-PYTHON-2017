...
df = data[['x', 'y', 'walk_t','walk_t_ud', 'car_r_t','car_r_t_ud', 'from_id', 'label_wt', "label_ct"]]
...
p = figure(title="Travel times to Helsinki city center by Walking", tools=TOOLS,
...
grid = p.patches('x', 'y', source=dfsource, name="grid",
         fill_color={'field': 'walk_t_ud', 'transform': color_mapper},
         fill_alpha=1.0, line_color="black", line_width=0.03, legend="walk_ct")
# Add roads
...
output_file = r"C:\Users\oyeda\Desktop\AUTOGIS\AUTOGIS_PERIOD2\assignment5\solution\wlak_access_map_Helsinki.html"
