# -*- coding: utf-8 -*-
"""
Created on Thu Oct 26 22:04:03 2017
...
#winter.plot(x= winter.index, y = 'TAVG_CELS', legend='winter', ylim=(y.max()+5,y.min()-5), ax=ax11, lw=2, c='blue')
    seasonalData_h[str(i)].plot(kind='bar', ylim=(-5,5),ax=ax11, figsize=(15, 10), legend=True, fontsize=12)
    #plt.title('Helsinki'+ str(i), fontsize=23)
    
    seasonalData_s[str(i)].plot(kind='bar', ylim=(-5,5),ax=ax12, figsize=(15, 10), title="Sodankyla", legend=False, fontsize=12)
